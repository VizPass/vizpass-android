...
import com.jonahchin.vizpass.R;
...
public final class FaceTrackerActivity extends AppCompatActivity {
    ...
    private static final String GALLERY_ID = "GalleryTwo";

    private static final String FIREBASE_ADMIN_ID = "3H9ibes1zagsg1EE1wUYMop7tWD3";
    ...
    public void onCreate(Bundle icicle) {
        ...
        if (rc == PackageManager.PERMISSION_GRANTED) {
            createCameraSource();
//            mPreview.stop(); // turn off camera
        } else {
            requestCameraPermission();
        }

        initWaitListener();
//        userEnters("soheilhamidi92");
    }

    private void initWaitListener() {
        stopCamera();
        mPersonSeen.addValueEventListener(new ValueEventListener() {
            @Override
